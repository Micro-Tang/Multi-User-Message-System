...
/**
 *validate_passt 验证密码提示是否有效
 * @access public
 * @returns {boolean}
 */
function validate_passt() {
    var passt = document.getElementById('passt').value.trim();
    if (passt=="") {
        document.getElementById('ms_passt').innerHTML='<span>(密码提示不能为空)<img src="images/wrong.png"></span>';
        return false;
    } else {
        document.getElementById('ms_passt').innerHTML='<span>(成功)<img src="images/success.png"></span>';
        return true;
    }
}

/**
 *validate_passd 验证问题回答是否有效
 * @access public
 * @returns {boolean}
 */
function validate_passd() {
    var passt = document.getElementById('passt').value.trim();
    var passd = document.getElementById('passd').value.trim();
    if (passd=="") {
        document.getElementById('ms_passd').innerHTML='<span>(密码回答不能为空)<img src="images/wrong.png"></span>';
        return false;
    }else if(passt == passd) {
        document.getElementById('ms_passd').innerHTML='<span>(密码提示与密码回答不能一致)<img src="images/wrong.png"></span>';
        return false;
    } else {
        document.getElementById('ms_passd').innerHTML='<span>(成功)<img src="images/success.png"></span>';
        return true;
    }
}
...
function validate_submit() {
    ...
    && document.getElementById('passt').value.trim()
    && document.getElementById('passd').value.trim())) {
